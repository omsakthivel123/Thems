...
<head>
	...
	<title> Annai Veilankannis Groups</title>


	<!-- Site favicon -->
	<link rel="icon" type="image/png" href="<?php echo base_url('assets/Images/Background/Login/favicon.png') ?>" sizes="64x64">
	...
	<div class="header">
		...
		<div class="header-right">
			...
			<div class="github-link">
				<a href="<?php echo base_url('https://github.com/dropways/deskapp') ?>" target="_blank"><img src="<?php echo base_url('vendors/images/github.svg') ?>" alt=""></a>
			</div>
		</div>
	</div>